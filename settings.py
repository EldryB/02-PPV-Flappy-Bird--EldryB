...
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_l, "jump")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_p, "pause_key")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_q, "easy")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_w, "hard")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_d, "move_left")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_a, "move_right")
...
TEXTURES = {
    ...
    "log_h": pygame.image.load(BASE_DIR / "assets" / "graphics" / "log_h.png"),
    "powerup": pygame.image.load(BASE_DIR / "assets" / "graphics" / "power_up.png"),
    "bird_power": pygame.image.load(BASE_DIR / "assets" / "graphics" / "bird_power.png"),
}
...
TEXTURES["logh_inverted"] = pygame.transform.flip(TEXTURES["log_h"], False, True)
